...
@Component({
  selector: 'complai-host-for-test',
  template: ''
})
class HostComponent {
  actionHandler = () => {};
...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<complai-big-input-action></complai-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<complai-big-input-action [disabled]="true"></complai-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<complai-big-input-action fontSet="fas" fontIcon="fa-trash"></complai-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<complai-big-input-action label="delete"></complai-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<complai-big-input-action (action)="actionHandler()"></complai-big-input-action>`;
    fixture = createHostComponent(template);
